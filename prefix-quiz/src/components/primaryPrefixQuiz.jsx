...
function PrimaryPrefixQuiz({ data, primaryPrefixMap }) {
    ...
    const generateQuestion = () => {
        ...
        setQuestion(prefix);
        setCorrectAnswer(primaryPrefixMap[prefix]);
    ...
    return (
        <>
            ...
            {
                question && <>
                    <p>Which DXCC is associated with prefix: <span style={{ fontSize: 18, fontWeight: 'bold' }}>{question}</span>?</p>
                    <FormGroup row>
                    <TextField 
...
export default PrimaryPrefixQuiz;